          ...
          <div class="content">
            ...
            <div class="inner">
              ...
              Anything you post on the wall will be viewable by everyone else.
                ...
                <textarea class="text_area" id="post" Name="post" rows="4" cols="80"><?php echo $Block2SiteVar;?></textarea>
                </div>
...
<?php
	...
	$sql="SELECT Notes, WorkPhone, HomePhone, CellPhone, email FROM Users WHERE id='".$_SESSION['id']."'";
	$result=mysql_fetch_assoc(mysql_query($sql));
	$num_rows=mysql_num_rows($result);
	$About=$result['Notes'];
...
?>
		...
		<center>
		<h4><?php echo $_SESSION['fn']; ?> <?php echo $_SESSION['ln']; ?>'s Picture</h4>
		<a href="profile.php?page=profile&option=commingsoon&user=<? echo $_SESSION['id']; ?>"><img src="image.php?src=<? echo $ProfilePicPath; ?>" border="0" /></a>
		<br />
		<br />
		</center>
        </div>
		...
		<h4>About <?php echo $_SESSION['fn']; ?> <?php echo $_SESSION['ln']; ?>:</h4>
		<?php echo $About; ?>
		<br />
		<br />
		...
		<h4><?php echo $_SESSION['fn']; ?> <?php echo $_SESSION['ln']; ?>'s Contact Info:</h4>
